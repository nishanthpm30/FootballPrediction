...
# ------------------------------
root = tk.Tk()
root.title("⚽ LaLiga Match Predictor")
root.geometry("400x400")
root.config(bg="#1B262C")

# Header Label
title_label = tk.Label(
    root,
    text="LaLiga Match Winner Predictor",
    font=("Arial", 16, "bold"),
    bg="#1B262C",
    fg="#FFD369",
)
...
tk.Label(root, text="Select Home Team:", bg="#1B262C", fg="white").pack()
...
tk.Label(root, text="Select Away Team:", bg="#1B262C", fg="white").pack()
